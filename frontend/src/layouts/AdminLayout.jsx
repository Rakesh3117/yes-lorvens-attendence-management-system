  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="md:pl-64 flex flex-col flex-1">
        {/* Top bar */}
        <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-900 dark:to-gray-800">
          <button
            type="button"
        ...
        {/* Header */}
        <div className="sticky top-0 z-10 flex-shrink-0 flex h-20 bg-white dark:bg-gray-800 shadow-xl border-b border-gray-200 dark:border-gray-700">
