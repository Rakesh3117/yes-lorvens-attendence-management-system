  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50">
        ...
        <div className={`relative flex-1 flex flex-col max-w-xs w-full bg-white transform transition ease-in-out duration-300 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              <h1 className="text-xl font-bold text-background-color bg-clip-text text-transparent">Admin Portal</h1>
            </div>
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center px-2 py-2 text-base font-medium rounded-lg transition-all duration-200 ${
                      isActive
                        ? 'background-color'
                        : 'text-gray-600 hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 hover:text-gray-900'
                    }`}
                    onClick={() => setSidebarOpen(false)}
                  >
                    <svg
      ...
      <div className="md:pl-64 flex flex-col flex-1">
        {/* Top bar */}
        <div className="sticky top-0 z-10 md:hidden pl-1 pt-1 sm:pl-3 sm:pt-3 bg-gradient-to-r from-indigo-50 to-purple-50">
          <button
            type="button"
              ...
              <div className="ml-3 relative">
                <div className="flex items-center space-x-4">
                  <div className="text-right">
                    ...
                    <div className="text-sm text-gray-500">{user?.employeeId} (Admin)</div>
                  </div>
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-lg text-sm leading-4 font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200 shadow-sm"
                  >
